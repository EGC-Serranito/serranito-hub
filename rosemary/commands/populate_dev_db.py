...
def populate_external_db():
    ...
    click.echo(click.style("Stay tunned this may take a while...", fg='yellow'))
    try:
        ...
        click.echo(click.style('Ups. Something bad happened. I just literally told you to configure env variables', fg='red'))
    finally:
        db.session.close()
